...
if(global.isCrateOpen && global.crate == self) {
	...
	for(var ix = 0; ix < width; ix++)
		for(var iy = 0; iy < height; iy++) {
			...
			var offX = -5.5;
			var offY = -28.5;
			var xx = o_hud.x+lengthdir_x(slotZ, -global.camera_angle+90)+lengthdir_x(offX+(ix*10.5), angle)+lengthdir_x(offY+(iy*10.5), angle-90);
			var yy = o_hud.y+lengthdir_y(slotZ, -global.camera_angle+90)+lengthdir_y(offX+(ix*10.5), angle)+lengthdir_y(offY+(iy*10.5), angle-90);
