...
if(!wait) {
		...
		// Drawing shadow
	draw_sprite_ext(sprite_index, item_, sx, sy, .75, .75, image_angle, c_black, .1);

	// Drawing sprite
	draw_sprite_ext(sprite_index, item_, xx, yy, .75, .75, image_angle, image_blend, image_alpha);
